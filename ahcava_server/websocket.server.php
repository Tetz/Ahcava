...
class WebSocketServer implements WebSocketObserver {
    ...
    public function run() {
        ...
        while (true) {
            //  $this->debug("   1   While Loop Started");
            clearstatcache();
	    ...
	    //TODO
	  //  $this->debug("   5   before IF statement");
